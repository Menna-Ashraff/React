...
export default function Parent() {
  const [products] = useState([
    ...
    },
    {
      ...
      description:
        "L'OrÃƒÂ©al Paris introduces Hyaluron Expert Replumping Serum formulated with 1.5% Hyaluronic Acid",
      price: 19,
  ...
  return (
    <>
      <div className="container">
        <h2 className="text-center mt-2 text-decoration-underline">Products</h2>
        <div className="row g-2 border mt-1">
          {products.map((product, index) => (
            <Child key={index} product={product} />
          ))}
        </div>
      </div>
    </>
