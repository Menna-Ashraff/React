              ...
              <div className="card-body">
                ...
                <div className="mt-2">
                  <Link
                    ...
                    className="btn btn-primary mb-2 me-1"> Details </Link>
                  <button onClick={() => handleDeleteProduct(product.id)} className="btn btn-danger mb-2 ms-1"> Delete </button>
                  <button onClick={() => handleAddToCart(product)} className="btn btn-warning me-2 w-100"> Add to Cart</button>
                </div>
              </div>
            </div>
          </div>
